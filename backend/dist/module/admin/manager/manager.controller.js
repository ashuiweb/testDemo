...
__decorate([
    (0, common_1.Get)(),
    (0, common_1.Render)('admin/manager/index'),
...
__decorate([
    (0, common_1.Get)('add'),
    (0, common_1.Render)('admin/manager/add'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ManagerController.prototype, "add", null);
__decorate([
    (0, common_1.Get)('edit'),
    (0, common_1.Render)('admin/manager/edit'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ManagerController.prototype, "edit", null);
exports.ManagerController = ManagerController = __decorate([
    (0, common_1.Controller)('admin/manager')
], ManagerController);
